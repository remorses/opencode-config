...
export default tool({
  description: `Read a video or audio file (mp4, webm, mov, mp3, wav) from a local path or URL and add it directly into model context for analysis. Only works with Google Gemini models; non-Gemini models will get an error from the provider. If you are not using a Gemini model, use a Gemini subagent or the describe-media tool instead.`,
  args: {
