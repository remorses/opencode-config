...
All 18 easing types with exact bezier/spring curves are in
[`jitter-easings.ts`](./jitter-easings.ts). Copy it into your project and use
`getJitterEasing(name, intensity)` to look up any Jitter easing.
