...
- if we are going to use an external library wiht not much examples in the codebase use websearch to find
  ...
  - example files in the library github repository, search for and fetch them with opensrc
